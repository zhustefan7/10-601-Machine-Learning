...
\begin{enumerate}
    ...
    \begin{list}{}
        \item $\square$ No written notes are shared or taken at any time
        \item $\square$ Learning is facilitated not circumvented; i.e., the purpose of seeking help is to learn and understand the problem instead of merely getting an answer
        \item $\square$ Help both given and received is reported in collaboration questions in the homework
        \item $\square$ The student updates his/her collaborative questions even if it is after submitting their own assignment
    \end{list}
    ...
    \textbf{Select all that apply:}
    \begin{list}{}
        \item $\square$ Searching on the internet for solutions or sample codes
        \item $\square$ Consulting people outside this class who have seen or solved the problem before
        \item $\square$ Turning in someone else's homework
        \item $\square$ Using anyone else's, or allowing other classmates to use your computer, Autolab or Gradescope in connection with this course
    \end{list}
    ...
    \textbf{First time:}
    \begin{list}{}
        \item $\square$ A one and a half letter grade reduction (e.g., \textbf{A} becomes \textbf{B-})
